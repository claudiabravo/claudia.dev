...
add_action( 'admin_enqueue_scripts', 'bldr_admin_page_styles' ); 
    ...
    function bldr_setup_menu(){
 	...
 	function bldr_init(){ 
		...
		printf(__('1.1.7 - Update: added many new social icon options to theme customizer', 'bldr' ));
		echo '</p>';
		
		echo '<p style="text-align: center;">';  
		printf(__('1.1.5 - updated demo link in description', 'bldr' ));
		echo '</p>';
		
		echo '<p style="text-align: center;">';  
		printf(__('1.1.4 - updated font awesome icons to 4.5', 'bldr' ));
		echo '</p>';
		...
		echo '<p style="text-align: center;">'; 
		printf(__('1.1.0 - minor bug fixes', 'bldr' ));
		echo '</p>'; 

...
function alchem_setup() {
	global $content_width, $alchem_options,$alchem_upgrade_from_options;
...
function alchem_scripts() {
   ...
   if( $button_font ){
    ...
    wp_enqueue_style( 'alchem-bootstrap',  get_template_directory_uri() .'/plugins/bootstrap/css/bootstrap.min.css', false, '', false );
	...
	wp_enqueue_style( 'magee-shortcode',  get_template_directory_uri() .'/css/shortcode.css', false, $theme_info->get( 'Version' ), false );
	...
	wp_enqueue_script( 'alchem-bootstrap', get_template_directory_uri() . '/plugins/bootstrap/js/bootstrap.min.js' );

	wp_enqueue_script( 'alchem-prettyPhoto', get_template_directory_uri() . '/js/jquery.prettyPhoto.js', array( 'jquery' ), null, true );
	wp_enqueue_script( 'alchem-parallax', get_template_directory_uri() . '/js/parallax.js', array( 'jquery' ), null, true );

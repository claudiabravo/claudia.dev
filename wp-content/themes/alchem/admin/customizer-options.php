...
// Sections Order
  ...
  $options['alchem_section_0_id'] = array(
	...
	$options['alchem_section_5_content'] = array(
		...
		'section' => $section,
		'type'    => 'textarea',
		'default' => '<h2 style="text-align: center"><span style="color: #ffffff">About Us</span></h2>
...
$options['alchem_woo_cart_menu_background_color'] =  array(
 ...
 ##### Sticky Header #####
  ...
  $options['alchem_sticky_background_color'] = array(
		'id' => 'alchem_sticky_background_color',
		'label'   => __( 'Background Color', 'alchem' ),
		'section' => $section,
		'type'    => 'color',
		'default' => '#000000',
  ...
  $options['alchem_sticky_opacity'] = array(
		  'id' => 'alchem_sticky_opacity',
		  'label'   => __( 'Background Opacity', 'alchem' ),
		  'section' => $section,
		  'type'    => 'text',
		  'default' => '0.7',
		  'description' => __( '0~1', 'alchem' )
	  );
...
$options['alchem_blog_archive_sidebar'] =  array(
        'id'          => 'alchem_blog_archive_sidebar',
        'label'      => __( 'Blog Archive/Author/Category Sidebar', 'alchem' ),
        'description'        => '',
        'default'         => 'none',
        'type'        => 'select',
        'section' => $section,

<?php 
   ...
   $section_id      = esc_attr(sanitize_title(alchem_option('section_2_id','section-3')));
 ...
 <?php if( $section_hide != '1' ):?>
  <section class="section magee-section alchem-home-section-2" id="<?php echo $section_id;?>">

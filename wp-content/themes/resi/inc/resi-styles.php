...
?>
	...
	<style> 
		...
		button, input[type="button"], input[type="reset"], input[type="submit"] { background: <?php echo esc_attr( get_theme_mod( 'resi_button_color', '#222222' )) ?>; }  
		<?php endif; ?>
		...
		button:hover, input[type="button"]:hover, input[type="reset"]:hover, input[type="submit"]:hover { background: <?php echo esc_attr( get_theme_mod( 'resi_button_hover_color', '#666666' )) ?>; } 
		<?php endif; ?>
